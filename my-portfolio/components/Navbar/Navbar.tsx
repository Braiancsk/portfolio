...
function Navbar() {
  ...
  return (
    ...
    <nav className="flex justify-between items-center">
      ...
      <button title="Mudar cor entre modo claro e escuro" className="xl:fixed top-[30px] right-[95px]" onClick={handleDarkMode}>
        {darkMode === 'dark' 
        ? 
      ...
      <ul className="fixed top-[20%] right-[50px] xl:flex hidden flex-col gap-6">
        <li className="transition hover:scale-110 hover:text-primary">
          <Link href="/">
            <a className={`dark:text-white text-light-text  link-border ${asPath === '/' ? 'active-link dark:text-primary text-light-btn-hover-hover dark:after:bg-primary after:bg-light-text' : 'after:bg-transparent'}`}>Ínicio</a>
          </Link>
        </li>
        <li className="transition hover:scale-110 dark:hover:text-primary">
        <Link href="/projetos">
            <a className={`dark:text-white text-light-text  link-border ${asPath === '/projetos' ? 'active-link dark:text-primary text-light-btn-hover-hover dark:after:bg-primary after:bg-light-text' : 'after:bg-transparent'}`}>Projetos</a>
          </Link>
        </li>
        <li className="transition hover:scale-110 dark:hover:text-primary">
        <Link href="/sobre">
            <a className={`dark:text-white text-light-text  link-border ${asPath === '/sobre' ? 'active-link dark:text-primary text-light-btn-hover-hover dark:after:bg-primary after:bg-light-text' : 'after:bg-transparent'}`}>Sobre</a>
          </Link>
        </li>
        <li className="transition hover:scale-110 dark:hover:text-primary">
        <Link href="/contato">
            <a className={`dark:text-white text-light-text  link-border ${asPath === '/contato' ? 'active-link dark:text-primary text-light-btn-hover-hover dark:after:bg-primary after:bg-light-text' : 'after:bg-transparent'}`}>Contato</a>
          </Link>
        </li> 
      </ul>
