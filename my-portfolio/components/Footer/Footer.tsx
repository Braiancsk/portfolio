...
function Footer() {
  return (
    <footer className="dark:bg-waves bg-light-bg p-7 relative transition duration-500">
        ...
        <path className="transition duration-500 dark:fill-waves fill-light-bg max-w-full" fillRule="evenodd" clipRule="evenodd" d="M0 90.5312H80C160 90.5312 320 90.5312 480 80.4722C640 70.4132 800 50.2951 960 70.4132C1120 90.5312 1280 150.885 1440 145.856C1600 140.826 1760 70.4132 1840 35.2066L1920 0V301.771H1840C1760 301.771 1600 301.771 1440 301.771C1280 301.771 1120 301.771 960 301.771C800 301.771 640 301.771 480 301.771C320 301.771 160 301.771 80 301.771H0L0 90.5312Z" fill="#32303B"/>
        </svg>
        </div>
        ...
        <p className="dark:text-white text-light-text font-bold container transition duration-500 md:text-left  text-center mt-5">© 2022 Braian Fellipe</p>
    </footer>
  )
}
