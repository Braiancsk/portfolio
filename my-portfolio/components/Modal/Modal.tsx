        ...
        >
          <div>
            ...
            <div className="flex items-center md:items-start md:flex-row flex-col gap-5">
              <div>
                <strong className="block text-black/80 font-bold text-xl lg:text-2xl text-center">
                  Vamos conversar?
                </strong>
                <p className="text-base text-black/80 text-center">
                  Me chama no WhatsApp e faça um orçamento sem compromisso
                </p>
                <a
                  title="Me chame no WhatsApp"
                  className="flex justify-center my-5 w-max mx-auto transition hover:scale-110"
                  href="https://wa.me/5562994901223/?text=Eu%20Gostaria%20de%20fazer%20um%20orçamento%20"
                >
              ...
              <div>
                ...
                <p className="text-base text-black/80 text-center">
                  Você também pode me contratar pelas seguintes plataformas
                </p>
                  ...
                  <li className="transition hover:scale-110 dark:hover:fill-primary icons">
                    <a href="https://www.99freelas.com.br/user/Braian-Fellipe">
                      <Image
                        ...
                        width={30}
                        height={30}
                        alt="icone da empresa 99Freelas, com fundo azul e dois noves desenhados nele"
                      />
                    </a>
                  </li>
