    ...
    <ModalBg visible={visible} closeModal={closeModal}>
      <motion.div
        ...
        <div >
            ...
            <strong className="block text-black/80 font-bold text-2xl lg:text-3xl text-center">Vamos conversar?</strong>
            <p className="text-base text-black/80 text-center">Me chama no WhatsApp e faça um orçamento sem compromisso</p>
            <a title="Me chame no WhatsApp" className="flex justify-center my-5 w-max mx-auto" href="https://wa.me/5562994901223/?text=Eu%20Gostaria%20de%20fazer%20um%20orçamento%20">
            <IoLogoWhatsapp className="text-green-500 text-5xl"/>
            </a>
            
            <strong className="block text-black/80 font-bold text-2xl lg:text-3xl text-center">Ou me contrate nas plataformas</strong>
