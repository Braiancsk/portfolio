...
function Menu() {
  ...
  return (
      <>
    <aside className={`transition duration-500 dark:bg-[#292731] bg-[#F7E2E2]/20 min-h-screen w-[80%] z-40 fixed ${menu ? 'translate-x-0' : 'translate-x-[-200%]'}`}>
    <ul className="flex flex-col gap-5 w-full p-8">

    <li className="flex items-center relative max-w-[130px] w-full justify-between">
    <Link href="/">
    <a onClick={handleMenu} className="transition duration-500 text-lg text-center dark:text-white text-light-text">Ínicio</a>
    </Link>
    ...
    <li className="flex items-center relative max-w-[130px] w-full justify-between">
    <Link href="/projetos">
    <a onClick={handleMenu} className="transition duration-500 text-lg text-center dark:text-white text-light-text">Projetos</a>
    </Link>
    ...
    <li className="flex items-center relative max-w-[130px] w-full justify-between">
    <Link href="/sobre">
    <a onClick={handleMenu} className="transition duration-500 text-lg text-center dark:text-white text-light-text">Sobre</a>
    </Link>
    ...
    <ul className="flex gap-6 py-4 px-8">
     ...
     <aside className="rounded-md fixed bottom-[20px] z-50 left-0 right-0 mx-auto max-w-[90%] w-full transition duration-500 dark:bg-[#0A121E] bg-[#5B7DB1] py-3 px-5 xl:hidden overflow-x-scroll">
     <ul className="flex justify-evenly gap-5">
       ...
       <TiHome className="transition duration-500 text-white font-bold text-2xl"/>
         <Link href="/">
           <a className="transition duration-500 text-white text-lg text-center">Ínicio</a>
         </Link>
       </li>
       ...
       <FaLightbulb className="transition duration-500 text-white font-bold text-2xl"/>
         <Link href="/projetos">
           <a className="transition duration-500 text-white text-lg text-center">Projetos</a>
         </Link>
       </li>
       ...
       <FaBookReader className="transition duration-500 text-white font-bold text-2xl"/>
         <Link href="/sobre">
           <a className="transition duration-500 text-white text-lg text-center">Sobre</a>
         </Link>
       </li>

       <li onClick={handleMenu} className="flex flex-col items-center">
       <HiOutlineMenuAlt3 className="transition duration-500 text-white font-bold text-2xl"/>
           <button className="transition duration-500 text-white text-lg text-center">Menu</button>
       </li>
     </ul>
   </aside>
   </>
