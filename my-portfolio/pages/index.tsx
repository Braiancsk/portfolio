...
const Home: NextPage = () => {
  ...
  return (
    ...
    >
      ...
      <section className="relative py-10 dark:bg-waves bg-light-bg">
        <svg
        ...
        <div className="container px-4 flex flex-col items-center z-1 relative">
          ...
          <section className="my-20">
            ...
            <Link href="/projetos">
              <a className="dark:text-primary text-light-text font-bold text-lg md:text-2xl flex items-center justify-center gap-4 text-center mt-[60px] md:mt-[200px]">
                Veja mais projetos
                <CgArrowTopRightR />
              </a>
            </Link>
      ...
      <section className="mt-[100px] md:mt-[300px] py-5">
        <div className="container px-4 relative z-[2]">
          <h2 className="text-center text-2xl md:text-3xl max-w-[354px] w-full mx-auto dark:text-white text-light-text">
      ...
      <section className="container my-[40px]">
        <h2 className="text-center text-2xl md:text-3xl max-w-[354px] w-full mx-auto dark:text-white text-light-text mb-3">Projetos pessoais</h2>
        <Text 
      ...
      <h2 className="text-center text-2xl md:text-3xl max-w-[354px] w-full mx-auto dark:text-white text-light-text mb-10">Vamos trabalhar juntos?</h2>
      <Button 
      url="/contato"
      isLink={true}
